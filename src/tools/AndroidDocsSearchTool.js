...
exports.AndroidDocsSearchTool = void 0;
class AndroidDocsSearchTool {
    constructor() {
        this.docsIndex = new Map();
        this.keywordIndex = new Map(); // keyword -> doc names
    ...
    search(query, limit = 5) {
        ...
        // Keyword matches
        const keywordMatches = new Map(); // doc name -> match count
...
exports.AndroidDocsSearchTool = AndroidDocsSearchTool;
//# sourceMappingURL=AndroidDocsSearchTool.js.map