...
exports.AndroidBuildTool = void 0;
const GradleParser_1 = require("../utils/parsers/GradleParser");
class AndroidBuildTool {
    constructor() {
        this.gradleParser = new GradleParser_1.GradleParser();
    }
    /**
     * Parse Gradle build error output
     * Delegates to GradleParser for error detection
     */
    parseBuildError(buildOutput) {
     ...
     */
    analyzeDependencyConflict(error) {
        if (error.type !== 'dependency_conflict') {
            return null;
        }
        if (!error.metadata) {
     ...
     */
    explainVersionChoice(versions, chosen) {
        if (versions.length === 1) {
...
dependencies {
     ...
     */
    generateKotlinResolution(module, version) {
...
dependencies {
     ...
     */
    diagnoseRepositoryIssues(error) {
        if (!error.metadata) {
            return null;
        }
     ...
     */
    static isBuildError(text) {
        return GradleParser_1.GradleParser.isGradleError(text);
    }
}
exports.AndroidBuildTool = AndroidBuildTool;
//# sourceMappingURL=AndroidBuildTool.js.map