...
export class ErrorClassifier {
  ...
  private isVersionDependency(message: string, fullText: string): boolean {
  ...
  private isManifestPermission(message: string, fullText: string): boolean {
  ...
  private isBuildCache(message: string, fullText: string): boolean {
    const cachePatterns = [
      /cache.*corrupt/,
  ...
  private isProguardMinification(message: string, fullText: string): boolean {
  ...
  private isNavigationRouting(message: string, fullText: string): boolean {
  ...
  private isNetworkConnectivity(message: string, fullText: string): boolean {
