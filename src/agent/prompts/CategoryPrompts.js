...
exports.CATEGORY_PROMPTS = void 0;
exports.getCategoryPrompt = getCategoryPrompt;
exports.buildEnhancedSystemPrompt = buildEnhancedSystemPrompt;
const ErrorClassifier_1 = require("../ErrorClassifier");
exports.CATEGORY_PROMPTS = {
    [ErrorClassifier_1.ErrorCategory.VERSION_DEPENDENCY]: `
...
`,
    [ErrorClassifier_1.ErrorCategory.MANIFEST_PERMISSION]: `
...
`,
    [ErrorClassifier_1.ErrorCategory.BUILD_CACHE]: `
...
`,
    [ErrorClassifier_1.ErrorCategory.PROGUARD_MINIFICATION]: `
...
`,
    [ErrorClassifier_1.ErrorCategory.NAVIGATION_ROUTING]: `
...
`,
    [ErrorClassifier_1.ErrorCategory.NETWORK_CONNECTIVITY]: `
...
`,
    [ErrorClassifier_1.ErrorCategory.UNKNOWN]: `
...
function getCategoryPrompt(category) {
    return exports.CATEGORY_PROMPTS[category];
}
/**
 * Combine category prompt with base system prompt
 */
function buildEnhancedSystemPrompt(basePrompt, category) {
...
//# sourceMappingURL=CategoryPrompts.js.map