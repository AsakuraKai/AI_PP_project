...
class GradleParser extends BaseParser_1.BaseParser {
    /**
    ...
    parse(errorText) {
        ...
        return (this.parseDependencyResolutionError(text) ||
     ...
     */
    parseDependencyResolutionError(text) {
        const patterns = [
     ...
     */
    parseBuildScriptSyntaxError(text) {
