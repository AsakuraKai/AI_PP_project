...
exports.JetpackComposeParser = void 0;
const BaseParser_1 = require("./BaseParser");
/**
 * Parser for Jetpack Compose framework errors
 */
class JetpackComposeParser extends BaseParser_1.BaseParser {
    /**
    ...
    parse(errorText) {
        ...
        return (this.parseRememberError(text) ||
     ...
     */
    parseDisposableEffectError(text) {
        const patterns = [
     ...
     */
    parseCompositionLocalError(text) {
        const patterns = [
     ...
     */
    extractCompositionLocalName(text) {
        const patterns = [
            /Local(\w+)/i,
...
exports.JetpackComposeParser = JetpackComposeParser;
//# sourceMappingURL=JetpackComposeParser.js.map