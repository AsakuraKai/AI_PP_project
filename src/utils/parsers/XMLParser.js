...
class XMLParser {
    ...
    parse(errorText) {
        ...
        return (this.parseAttributeError(errorText) || // Check attribute error before inflation
     ...
     * ```
     */
    parseTagMismatchError(errorText) {
     ...
     * ```
     */
    parseResourceNotFoundError(errorText) {
     ...
     * ```
     */
    parseDuplicateIdError(errorText) {
     ...
     * ```
     */
    parseInvalidAttributeValueError(errorText) {
