...
const KotlinNPEParser_1 = require("../KotlinNPEParser");
class KotlinParser {
    constructor() {
        this.npeParser = new KotlinNPEParser_1.KotlinNPEParser();
    }
    /**
    ...
    parse(errorText) {
        ...
        return (this.parseImportError(text) ||
