...
class LanguageDetector {
     ...
     */
    static detect(errorText, filePath) {
        if (!errorText) {
     ...
     */
    static isCompose(_textLower, originalText) {
     ...
     */
    static isKotlin(_textLower, originalText) {
     ...
     */
    static getConfidence(errorText, detectedLanguage) {
        ...
        const indicators = strongIndicators[detectedLanguage];
        if (indicators) {
