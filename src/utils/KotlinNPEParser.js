...
exports.KotlinNPEParser = void 0;
class KotlinNPEParser {
    /**
     ...
     */
    static isKotlinError(errorText) {
        if (!errorText)
            return false;
        return (/\.kt:/i.test(errorText) || // Contains .kt file reference
...
exports.KotlinNPEParser = KotlinNPEParser;
// Regex patterns for different Kotlin error types
KotlinNPEParser.PATTERNS = {
...
//# sourceMappingURL=KotlinNPEParser.js.map